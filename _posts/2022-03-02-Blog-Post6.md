...
From the above result, we can see that our the validation accuracy of our model 1 reached around 98.9%, which is not bad! However, we can do it better in our next model!
