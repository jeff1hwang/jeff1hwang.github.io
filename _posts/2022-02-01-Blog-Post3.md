...
This is a web scraping project for PIC16B at UCLA. In this project, I wrote a web scraper using Scrapy to collect a list of movies on IMDB to show that which movies share at least one actor with our favorite movie. The link to the Github repository: [https://jeff1hwang.github.io/Blog-Post3/](https://jeff1hwang.github.io/Blog-Post3/)
