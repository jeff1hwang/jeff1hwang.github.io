...
def visualize_img():
    ...
    random_cats = random.sample(cats, 3)
    random_dogs = random.sample(dogs, 3)

    # Merging two lists together
    cats_and_dogs = random_cats + random_dogs
    ...
    for j in cats_and_dogs:
        ...
        if class_names[labels[j]] == "dogs":
            if count_dogs >= 4:
                continue
            ax = plt.subplot(2, 3, count_dogs+3)
...
### Visualize RandomFlip & RandomRotation
